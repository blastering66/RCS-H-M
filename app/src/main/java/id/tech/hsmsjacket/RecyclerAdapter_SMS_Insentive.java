...
public class RecyclerAdapter_SMS_Insentive extends RecyclerView.Adapter<RecyclerAdapter_SMS_Insentive.ViewHolder> {
    private Activity activity_adapter;
    private Context context_adapter;
    private List<RowData_Sms> data;
    private SharedPreferences sh;

    public RecyclerAdapter_SMS_Insentive(Context context_adapter, List<RowData_Sms> data) {
...
//            holder.tv_tgl.setVisibility(View.GONE);
        ...
        if(item.viewed.equals("0")){
            holder.tv_status.setText("Pesan Baru");
        }else{
        ...
        holder.wrapper.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cv.put("viewed", "1");
                db.update("tbl_sms_insentive", cv, "id = ?", new String[]{item._id});
